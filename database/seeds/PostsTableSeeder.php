    ...
    public function run()
    {
        ...
        DB::table('posts')->insert([
            ...
            [
                ...
                'en_content' => '<h4>Banking and Secured Transactions</h4><p>In connection with banking and secured transactions field, AKFS will advise clients on mortgages, pledges and any other security Instruments applicable under prevailing laws and regulation.</p><h4>Real Estate</h4><p>In relation to real estate industry, AKFS provides consulting services related to land and property issues that are closely related to the legal aspects, especially agrarian law. With our experiences, we are confident to bring a sense of security and comfort from the legal side for our clients who want to establish property/real estate business and for our clients who need legal consultation before buying a property.</p>',
                'id_title' => 'Perusahaan Komersil',
                'id_content' => '<h4>Perbankan dan Transaksi Terjamin</h4><p>Sehubungan dengan bidang perbankan dan transaksi aman, AKFS akan memberi tahu klien tentang hipotek, gadai, dan Instrumen keamanan lainnya yang berlaku berdasarkan hukum dan peraturan yang berlaku. </ p ><h4>Real Estate</h4><p>Terkait dengan industri real estate, AKFS memberikan layanan konsultasi terkait masalah tanah dan properti yang sangat erat kaitannya dengan aspek hukum, khususnya hukum agraria. Dengan pengalaman yang kami miliki, kami yakin dapat menghadirkan rasa aman dan nyaman dari sisi hukum bagi klien kami yang ingin mendirikan bisnis properti / real estate dan untuk klien kami yang membutuhkan konsultasi hukum sebelum membeli properti.</p>'
            ],
            [
                'category_id' => 1,
                'user_id' => 1,
